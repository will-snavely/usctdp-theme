<header class="banner bg-neutral-400" x-data="{ mobileMenuOpen: false }">
  ...
  <div id="mobile-menu" class="lg:hidden absolute w-full bg-white shadow-lg pb-4 z-40 border-t border-gray-600"
    ...
    x-transition:leave-end="opacity-0 transform -translate-y-2" x-on:click.away="mobileMenuOpen = false">
