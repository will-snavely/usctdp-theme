<div class="max-w-2xl mx-auto my-12 px-6">
    ...
    <div class="bg-white rounded-3xl shadow-xl overflow-hidden border border-slate-100 p-8 md:p-12">
        <h2 class="text-2xl font-bold text-slate-900 mb-6 uppercase tracking-tight text-center">Login</h2>
        ...
        @if (get_option('woocommerce_enable_myaccount_registration') === 'yes')
            <div class="mt-8 pt-8 border-t border-slate-100 text-center">
                <p class="text-slate-600 mb-4">New here? Join the program to track your sessions, manage gear orders,
                    and get early access to clinics.</p>
                <a href="/register"
